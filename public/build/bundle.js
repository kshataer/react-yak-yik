...
var _Base = __webpack_require__(/*! ./components/layout/Base */ "./src/components/layout/Base.js");
...
var _AddComment = __webpack_require__(/*! ../presentation/AddComment */ "./src/components/presentation/AddComment.js");
...
var Comments = function (_Component) {
  ...
  _createClass(Comments, [{
    key: "handleUpdatedComment",
    value: function handleUpdatedComment(event) {
    ...
    value: function handleAddComment() {
      var updatedComment = Object.assign({}, this.state.comment);
      var zoneIdValue = document.getElementById("zoneId").value;
      updatedComment["zoneId"] = zoneIdValue;

      _superagent2.default.post(url_api + "comment").send(JSON.stringify(updatedComment)).set("Content-Type", "application/json").set("Accept", "application/json").then(function (res) {
    ...
    value: function render() {
      var commentItems = [];
      commentItems = this.props.listComments.comments.map(function (comment, i) {
        return _react2.default.createElement(_Comment2.default, { key: i, currentComment: comment });
      });

      var commentSName = this.props.listComments.zone.name ? "Comments of " + this.props.listComments.zone.name : "";

      var addComment = this.props.listComments.zone.name ? _react2.default.createElement(
        "div",
        { className: "mt-2" },
        _react2.default.createElement(_AddComment2.default, {
          zoneId: this.props.listComments.zone._id ? this.props.listComments.zone._id : this.props.listComments.zone.zoneId,
...
var _AddZone = __webpack_require__(/*! ../presentation/AddZone */ "./src/components/presentation/AddZone.js");
...
var Zones = function (_Component) {
  ...
  _createClass(Zones, [{
    ...
    value: function componentWillMount() {
      ...
      _superagent2.default.get(url_api + "zone").query(null).set("Accept", "application/json").end(function (err, res) {
        if (err) {
          alert("ERROR ZONE GET" + err);
        }
        _this2.setState({ listZones: res.body.results });
      });
    }
  }, {
    key: "handleShowComments",
    value: function handleShowComments(zone) {
      var _this3 = this;

      _superagent2.default.get(url_api + "zonecomments/" + (zone._id ? zone._id : zone.zoneId)).query(null).set("Accept", "application/json").end(function (err, res) {
        if (err) {
    ...
    value: function handleUpdateZone(event) {
    ...
    key: "handleAddZone",
    value: function handleAddZone() {
      var _this4 = this;

      _superagent2.default.post(url_api + "zone").send(JSON.stringify(this.state.zone)).set("Content-Type", "application/json").set("Accept", "application/json").then(function (res) {
        console.log("SUCCESS POST ZONE " + JSON.stringify(res.body));

        _this4.state.zone.zoneId = res.body.result._id;
        var zips = _this4.state.zone.zipCodes;
        var zip = zips.split(",");
        var newZips = [];
        ...
        _this4.state.zone.zipCodes = newZips;
        var updatedZones = Object.assign([], _this4.state.listZones);
        updatedZones.push(_this4.state.zone);

        _this4.setState({ listZones: updatedZones });
    ...
    value: function render() {
      ...
      var zoneItems = this.state.listZones.map(function (zone, i) {
        return _react2.default.createElement(_Zone2.default, {
          zoneId: zone._id ? zone._id : zone.zoneId,
          onClickShowComments: function onClickShowComments() {
            return _this5.handleShowComments(zone);
          },
          key: i,
          currentZone: zone
        });
      ...
      var listComments = this.state.listComments;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            zoneItems,
            _react2.default.createElement(_AddZone2.default, {
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(_Comments2.default, { listComments: listComments })
          )
        )
      );
    }
...
var _Navbar = __webpack_require__(/*! ./Navbar */ "./src/components/layout/Navbar.js");

var _Navbar2 = _interopRequireDefault(_Navbar);

var _Footer = __webpack_require__(/*! ./Footer */ "./src/components/layout/Footer.js");
...
/***/ "./src/components/presentation/AddComment.js":
/*!***************************************************!*\
  !*** ./src/components/presentation/AddComment.js ***!
  \***************************************************/
/*! no static exports found */
...
function AddComment(props) {
  return _react2.default.createElement(
    ...
    null,
    _react2.default.createElement("input", { id: "zoneId", type: "hidden", value: props.zoneId }),
    _react2.default.createElement("input", {
    ...
    _react2.default.createElement(
      "button",
      { onClick: props.addComment, className: "btn btn-info" },
      "Add comment"
    )
  );
}
...
/***/ "./src/components/presentation/AddZone.js":
/*!************************************************!*\
  !*** ./src/components/presentation/AddZone.js ***!
  \************************************************/
/*! no static exports found */
...
function AddZone(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      "button",
      { onClick: props.addZone, className: "btn btn-info" },
      "Add zone"
    )
  );
}

exports.default = AddZone;
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          "span",
          null,
          (0, _dateformat2.default)(this.props.currentComment.timestamp, "yyyy-mm-dd hh:mm:ss")
        )
      );
    }
  }]);
...
var Zone = function (_Component) {
  ...
  _createClass(Zone, [{
    key: "render",
    value: function render() {
      var zips = this.props.currentZone.zipCodes.map(function (code, i) {
        return _react2.default.createElement(
          "div",
          { key: i },
          _react2.default.createElement(
